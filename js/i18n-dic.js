/* ============================================================================
   DICIONÁRIO PT → EN
   ============================================================================
   Indexado pelo texto em português exatamente como está no index.html, incluindo
   &nbsp;, &amp; e acentuação. Se a chave não casar ao caractere, não traduz.

   O que deliberadamente NÃO está aqui, e por quê:
     · nomes de pessoas e marcas — Magalu, Keeta, Sicredi, Cássio Guiot
     · cargos que já estão em inglês — CEO, COO, Account Director, Creative
       Leader, Media Director, Planning Director, Influencer Lead
     · métricas que já estão em inglês — Total views, Views Meta, Followers,
       Engagement rate
     · números e placeholders — 0K, +0k, 0M, R$0K, (nº)
     · a linha de emojis da persona
   Chave ausente = fica em português, que é o comportamento correto para nome
   próprio. Traduzir "Marcos Muniz" seria o bug, não a omissão.
   ========================================================================= */
window.DIC_EN = {
...
'de comunicação': 'communications groups',
...
'em protagonistas': 'protagonists of',
'da cultura digital': 'digital culture',
'Social First Agency': 'Social First Agency',

/* ── 8 · o consumidor mudou ───────────────────────────────────────────── */
'O Consumidor Mudou': 'The Consumer Changed',
'Pessoa em movimento numa galeria de arte': 'Person moving through an art gallery',
'PORQUE': 'WHY DO WE',
'EXISTIMOS?': 'EXIST?',
'Velocidade': 'Speed',
...
/* ── 9 · as marcas precisam ser ───────────────────────────────────────── */
'As Marcas Precisam Ser': 'Brands Need to Be',
'Relevantes': 'Relevant',
'Conectadas': 'Connected',
'Ágeis': 'Agile',

/* ── 10 · unir criatividade, dados e influência ───────────────────────── */
'Unir Criatividade, Dados e Influência': 'Uniting Creativity, Data and Influence',
'Nosso papel:': 'Our role:',
...
'Framework em 8 Etapas': '8-Step Framework',
'Definição de': 'Defining',
'objetivos': 'strategic',
'estratégicos': 'objectives',
'Seleção de': 'Selecting the',
'players': 'players',
'analisados': 'to analyse',
'Coleta de': 'Collecting',
'dados em redes': 'social media',
'redes a serem': 'channels to be',
'analisadas': 'analysed',
'Análise': 'Analysis',
'via IA': 'via AI',
'I.A de territórios': 'AI territory',
'análise': 'analysis',
'Modelagem via': 'Modelling via',
'de personas': 'personas',
'Criação via I.A': 'AI-driven creation',
'formatos de': 'of content',
'sociais': 'formats',
'Ajustes,': 'Adjustments,',
'calibragens e': 'calibration and',
'recomendações': 'recommendations',
'e outros': 'and others',
'(cenário atual).': '(current landscape).',

/* ── 13 · persona e matriz de canais ─────────────────────────────────── */
'Persona e Matriz de Canais': 'Persona and Channel Matrix',
'Persona': 'Persona',
'Beatriz, 32 anos, persona da marca': 'Beatriz, 32, the brand persona',
'Beatriz, 32,': 'Beatriz, 32,',
...
'Encantador': 'Charming',
'Tom': 'Tone',
'comunicação / criativa /': 'communication / creative /',
'para aproximação com': 'to connect with',
'públicos mais jovens': 'younger audiences',
'Territórios': 'Territories',
'Territórios Instagram': 'Instagram Territories',
'Gráfico radar de territórios no Instagram': 'Radar chart of Instagram territories',
'Moda &amp; Estilo de Vida': 'Fashion &amp; Lifestyle',
'Gastronomia Gourmet': 'Gourmet Food',
'Entretenimento &amp; Cultura': 'Entertainment &amp; Culture',
'Facilidades &amp; Serviços': 'Convenience &amp; Services',
'Institucional &amp; Propósito': 'Corporate &amp; Purpose',
'o lifestyle ganha forma em': 'lifestyle takes shape through',
'imagens, experiências e': 'images, experiences and',
'histórias': 'stories',
'Canal': 'Channel',
'Objetivo / Papel': 'Objective / Role',
'Público': 'Audience',
'KPI prioritário': 'Priority KPI',
'Prior.': 'Prior.',
'Gerar Desejo e': 'Drive Desire and',
'Pertencimento': 'Belonging',
'Engajamento': 'Engagement',
'Alta': 'High',
'Criar Experiências': 'Create Unforgettable',
'Inesquecíveis': 'Experiences',
'Compartilhamento': 'Sharing',
'Melhorar a Vida': 'Improve People’s',
'das Pessoas': 'Lives',
'Retenção': 'Retention',
'Engajamento e Inspiração': 'Engagement and Inspiration',
'Interação': 'Interaction',
'Awareness': 'Awareness',
'Alcance': 'Reach',
'Viralização': 'Virality',
'Propósitos': 'Purpose',

/* ── 14 · showreel ───────────────────────────────────────────────────── */
'Showreel WT.AG': 'WT.AG Showreel',
'Reproduzir showreel': 'Play showreel',

/* ── 15 · marcas parceiras ───────────────────────────────────────────── */
'Marcas Parceiras': 'Partner Brands',
'São Judas Universidade': 'São Judas University',
'apresenta': 'presents',
...
'Duas sedes': 'Two offices',
'Sedes': 'Offices',
'Clique para abrir o vídeo': 'Click to open the video',
'Sede da WT.AG em São Paulo': 'WT.AG office in São Paulo',
...
'Durante a Copa, o mercado disputa atenção com os mesmos formatos e criadores. O Magalu foi por outro caminho: em vez de contratar, revelou influência através dos seus próprios afiliados.': 'During the World Cup, the market competes for attention with the same formats and the same creators. Magalu took another route: instead of hiring influence, it revealed the influence its own affiliates already had.',
'Durante a Copa do Mundo, o mercado tende a disputar atenção com os mesmos formatos, criadores e narrativas. O Magalu foi por um caminho diferente: em vez de contratar, revelou influência através dos seus afiliados. São pessoas reais, com comunidades próprias, que com a estratégia certa, convertem influência em renda.': 'During the World Cup, the market tends to compete for attention with the same formats, the same creators and the same narratives. Magalu took a different route: instead of hiring influence, it revealed the influence its affiliates already had. They are real people with communities of their own who, given the right strategy, turn influence into income.',
'“Craques Gigantes” foi uma competição nacional que transformou afiliados em jogadores de uma liga de vendas, convertendo influência real em renda extra no maior campo do mundo: o feed.': '“Craques Gigantes” was a nationwide competition that turned affiliates into players in a sales league, converting real influence into extra income on the biggest pitch in the world: the feed.',
'A campanha &quot;Craques Gigantes&quot; surgiu como uma competição nacional que transformou afiliados em jogadores de uma liga de vendas, valorizando a influência real, gerada por brasileiros comuns, e convertendo em oportunidade concreta de renda extra no maior campo do mundo: o feed.': 'The &quot;Craques Gigantes&quot; campaign came to life as a nationwide competition that turned affiliates into players in a sales league. It put a value on real influence — the kind ordinary Brazilians already hold — and converted it into a concrete chance to earn more on the biggest pitch in the world: the feed.',
'No delivery, tudo foi pensado para chegar rápido. Os entregadores já tinham canais para tirar dúvidas. A informação existia — o desafio era fazê-la chegar de forma mais próxima e humana.': 'In delivery, everything is built for speed. Couriers already had channels to get their questions answered. The information was there — the challenge was making it land in a closer, more human way.',
'No delivery, tudo foi pensado para chegar rápido. Mas, para quem está na rua, uma resposta precisava fazer mais do que informar. Os entregadores já tinham canais para tirar dúvidas sobre bag, pagamentos, suporte, performance e uso do aplicativo. A informação existia. O desafio era fazê-la chegar de forma mais próxima, humana e conectada à linguagem de quem vive o corre.': 'In delivery, everything is built for speed. But out on the street, an answer had to do more than inform. Couriers already had channels for questions about the bag, payments, support, performance and how to use the app. The information was there. The challenge was making it land in a way that felt closer, more human and spoken in the language of people who live the hustle.',
'O problema nunca foi a falta de informação: era a falta de identificação. O mapeamento da comunidade revelou uma forte conexão com a cultura do rap e da rima.': 'The problem was never a lack of information: it was a lack of recognition. Mapping the community revealed a strong connection to rap and rhyme.',
...
'Odontoprev · Dia das Mães': 'Odontoprev · Mother’s Day',
...
'Conteúdos da liga de vendas': 'Content from the sales league',
'Grade de conteúdos dos afiliados': 'Grid of affiliate content',
'Live de premiação': 'Awards livestream',
'Live de premiação da campanha': 'Campaign awards livestream',
'Entregadores Keeta na Central do Corre': 'Keeta couriers on Central do Corre',
'Comentários dos entregadores': 'Courier comments',
'Comentários reais dos entregadores': 'Real comments from couriers',
'Comentários reais de entregadores': 'Real comments from couriers',
...
/* ── texto com marcação por dentro ────────────────────────────────────────
   ...
   deles vive em nós de texto soltos ao lado de <br>, <i> ou <kbd>, e o motor
...
'Análise<br>via IA': 'Analysis<br>via AI',
'Modelagem via<br>I.A de territórios<br>e outros<br>formatos de<br>análise': 'AI modelling of<br>territories and<br>other formats<br>of analysis',
'Criação via I.A<br>de personas<br>(cenário atual).': 'AI-driven creation<br>of personas<br>(current landscape).',
'Ajustes,<br>calibragens e<br>recomendações': 'Adjustments,<br>calibration and<br>recommendations',
'Criar Experiências<br>Inesquecíveis': 'Create Unforgettable<br>Experiences',
'Beatriz, 32,<br>comunicação / criativa /<br>multitarefas': 'Beatriz, 32,<br>communications / creative /<br>multitasking',
'Engajamento e Inspiração<br>o lifestyle ganha forma em<br>imagens, experiências e<br>histórias': 'Engagement and Inspiration<br>lifestyle takes shape through<br>images, experiences and<br>stories',
...
/* ── 26 · encerramento ───────────────────────────────────────────────── */
'Visualizações': 'Views',
'Alcance orgânico': 'Organic reach',
'Interações': 'Interactions',
'Afiliados': 'Affiliates',
'Conteúdos': 'Content pieces',
'Cresc. em vendas': 'Sales growth',
'Itens vendidos': 'Items sold',
'Engajamento total': 'Total engagement',
'Sentimento positivo': 'Positive sentiment',
